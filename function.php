<?php
	...
	function insertKhoa_hoc($connect, $ten_khoa_hoc, $ten_tac_gia, $thumbnail){
		$SQL = "INSERT INTO khoa_hoc (ten_khoa_hoc, ten_tac_gia, thumbnail) VALUES('".$ten_khoa_hoc."', '".$ten_tac_gia."', '".$thumbnail."')";
		$Query = mysqli_query($connect, $SQL);
	}

	function updateKhoa_hoc($connect, $ten_khoa_hoc, $ten_tac_gia, $thumbnail, $id_khoa_hoc){
		$SQL = "UPDATE khoa_hoc SET ten_khoa_hoc = '".$ten_khoa_hoc."', ten_tac_gia = '".$ten_tac_gia."', thumbnail = '".$thumbnail."' WHERE id_khoa_hoc =".$id_khoa_hoc;
		$Query = mysqli_query($connect, $SQL);
	}
